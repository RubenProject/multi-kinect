...
typedef ImageFormat<3, GL_RGB, GL_RGB, GL_UNSIGNED_BYTE> F6C3;
...
typedef ImageFormat<2, GL_R16F, GL_RED, GL_FLOAT> F16C1;
...
public:
    ...
    void upload()
    {
        ...
        glTexSubImage2D(GL_TEXTURE_RECTANGLE, 0, 0, 0, width, height, FormatT::Format, FormatT::Type, data);
    }
